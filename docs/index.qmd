...
::: panel-tabset
```{r godwit-image, echo=FALSE}
godwit_path <- here::here("figures", "Bar-tailed_Godwit.jpeg")
```
![Bar-tailed Godwit](`r godwit_path`)

```{r curlew-image, echo=FALSE}
curlew_path <- here::here("figures", "Far_Eastern_Curlew.jpeg")
```
![Far Eastern Curlew](`r curlew_path`)

```{r lapwing-image, echo=FALSE}
lapwing_path <- here::here("figures", "Masked_Lapwing.jpeg")
```
![Masked Lapwing](r lapwing_path)

```{r plover-image, echo=FALSE}
plover_path <- here::here("figures", "Pacific_Golden-Plover.jpeg")
```
![Pacific Golden-Plover](r plover_path)

```{r stilt-image, echo=FALSE}
stilt_path <- here::here("figures", "Pied_Stilt.jpeg")
```
![Pied Stilt](r stilt_path)

```{r avocet-image, echo=FALSE}
avocet_path <- here::here("figures", "Red-necked_Avocet.jpeg")
```
![Red-necked Avocet](r avocet_path)
