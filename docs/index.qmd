...
#### Available vs Used {#available}

```{r 4 Load data available vs Used, message = FALSE, warning = FALSE, echo = TRUE, eval = TRUE, results = 'asis'}
...
```{r 4 Available vs Used, message = FALSE, warning = FALSE, echo = TRUE, eval = TRUE, results = 'asis'}
...
# 2 - Adding variable duration for birds ----
...
for(i in 1:nrow(period_sp)) {
  ...
  # Filter tide_data for this species' period
...
FIGURE 1 : Movement and spatial ecology varies across species and within local MOTUS array in NSW

::: panel-tabset

## Diurnal_Low

```{r 4 1, message = FALSE, warning = FALSE, echo = TRUE, eval = TRUE, results = 'asis'}
plots[[1]]
```

## Nocturnal_Low

```{r 4 2, message = FALSE, warning = FALSE, echo = TRUE, eval = TRUE, results = 'asis'}
...
```{r 4 3, message = FALSE, warning = FALSE, echo = TRUE, eval = TRUE, results = 'asis'}
...
```{r 4 4, message = FALSE, warning = FALSE, echo = TRUE, eval = TRUE, results = 'asis'}
