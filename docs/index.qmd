...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh;">
  <figure>
    ...
    Table 1: Shorebirds species MOTUS monitored within and across the Hunter estuary
    </figcaption>
  </figure>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh;">
  <figure>
    <img src="figures/motus_filter_count.png"
...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh;">
  <figure>
    <img src="figures/motus_filter_perc.png"
...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh;">
  <figure>
    <img src="figures/available_used_schema.png"
         alt="Schema 1: Definition of available and used period across bird individuals and MOTUS stations"
         style="display: block; margin: auto; width: 90vw; max-width: 950px; height: auto;">
    <figcaption style="text-align: center; margin-top: 0.5em;">
      Schema 1: Definition of available and used period across bird individuals and MOTUS stations
    </figcaption>
  </figure>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh;">
  <figure>
    <img src="figures/tide.png"
         ...
         style="display: block; margin: auto; width: 90vw; max-width: 950px; height: auto;">
    <figcaption style="text-align: center; margin-top: 0.5em;">
    Schema 2: Definition of tide variables (high or low) for one period
    </figcaption>
  </figure>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh;">
  <figure>
    <img src="figures/pulse_interval.png"
         alt="Schema 2: Definition of tide variables"
         style="display: block; margin: auto; width: 90vw; max-width: 950px; height: auto;">
    <figcaption style="text-align: center; margin-top: 0.5em;">
      Schema 2: Definition of tide variables (high or low) for one period
    </figcaption>
...
Now the *used* and available determined, we can plot the results. 
