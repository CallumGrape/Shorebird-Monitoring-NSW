...
ggplot2::ggsave( here::here("docs", "figures", "motus_survey_h.png"), motus_survey_h, 
                 width = 15, height = 6, dpi = 300)
```

[![MOTUS Survey Plot - hours](figures/motus_survey_h.png){width=100%}](figures/motus_survey_h.png){target="_blank"}
...
ggplot2::ggsave( here::here("docs", "figures", "motus_survey_d.png"), motus_survey_d, 
                 width = 15, height = 6, dpi = 300)
```

[![MOTUS Survey Plot - days](figures/motus_survey_d.png){width=100%}](figures/motus_survey_d.png){target="_blank"}
