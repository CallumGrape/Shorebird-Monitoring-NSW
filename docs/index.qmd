...
```{r 03 TABLE 1bis , message = FALSE, warning = FALSE, eval = TRUE, echo = TRUE}
...
```{r 03 TABLE 1tris, message = FALSE, warning = FALSE, eval = TRUE, echo = FALSE}
...
DT::datatable(
  ...
  extensions = c('FixedColumns'),
  caption = 'Table 2: Overview on detection quality accross tagged individuals'
) %>%
  DT::formatStyle(
    'variable',
    fontWeight = 'bold'
