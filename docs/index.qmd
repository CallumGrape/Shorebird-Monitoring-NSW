...
Since 2021, we trapped `r moni$value[moni$variable == "nb_tagged"]` birds, and `r moni$value[moni$variable == "nb_released"]` were released and potentially detectable across our MOTUS array.
