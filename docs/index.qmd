...
Also, for more talkative results we filtered out Masked Lapwing and Far Estearn Curlew from the analysis.  
  
Before to start plotting we provide the below code which generate this helpful value.  
