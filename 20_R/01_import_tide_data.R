...
saveRDS(tideData, here::here("10_data", "tides", "tideData.rds"))
saveRDS(tidalCurve, here::here("10_data", "tides", "tidalCurve.rds"))
saveRDS(tidalCurveFunc, here::here("10_data", "tides", "tidalCurveFunc.rds"))
### OLD
